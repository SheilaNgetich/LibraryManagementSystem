...
public class EditAdmin extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jLabel1.setText("Edit Admin's Details");

        columnList.setFont(new java.awt.Font("Comic Sans MS", 1, 14)); // NOI18N
        ...
        t1.setFont(new java.awt.Font("Comic Sans MS", 1, 14)); // NOI18N

        update.setFont(new java.awt.Font("Comic Sans MS", 1, 16)); // NOI18N
            ...
            .addGroup(javax.swing.GroupLayout.Alignment.TRAILING, jPanel1Layout.createSequentialGroup()
                ...
                .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.TRAILING, false)
                    .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                        ...
                        .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.TRAILING, false)
                            .addComponent(t1)
                            .addComponent(columnList, 0, 189, Short.MAX_VALUE)))
    ...
    private void updateActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_updateActionPerformed
        try {
            ...
            //Getting user input
            String column = String.valueOf(columnList.getSelectedItem());
            String userInput = String.valueOf(t1.getText());
            //creating a statement object
            Statement st = con.createStatement();
            String query = "UPDATE admin SET " + column + " = '" + userInput + "'";
